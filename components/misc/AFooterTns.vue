<template>
    <v-footer class="caption transparent">
        <v-spacer></v-spacer>
        <p class="mb-0"> Provided by <a :href="url" target="_blank">TNS <img src="https://wis-tns.weizmann.ac.il/sites/default/files/favicon.png" alt="TNS icon"></a></p>
    </v-footer>
</template>
<script>
export default {
