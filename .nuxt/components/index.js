...
export { default as Aladin } from '../../components/misc/Aladin.vue'
export { default as Footer } from '../../components/misc/Footer.vue'
export { default as FooterTns } from '../../components/misc/FooterTns.vue'
export { default as Header } from '../../components/misc/Header.vue'
...
export const LazyAladin = import('../../components/misc/Aladin.vue' /* webpackChunkName: "components/misc/Aladin'}" */).then(c => c.default || c)
export const LazyFooter = import('../../components/misc/Footer.vue' /* webpackChunkName: "components/misc/Footer'}" */).then(c => c.default || c)
export const LazyFooterTns = import('../../components/misc/FooterTns.vue' /* webpackChunkName: "components/misc/FooterTns'}" */).then(c => c.default || c)
export const LazyHeader = import('../../components/misc/Header.vue' /* webpackChunkName: "components/misc/Header'}" */).then(c => c.default || c)
