    ...
    computed: {
        links() {
            return [
                {
                    name: "NED",
                    link: "https://ned.ipac.caltech.edu/conesearch?search_type=Near+Position+Search&iau_style=liberal&objname=&coordinates=" +
                ...
                {
                    name: "SIMBAD",
                    link: "http://simbad.u-strasbg.fr/simbad/sim-coo?Coord=" +
                          this.ra +
                          "%20" +
                          this.dec +
                ...
                {
                    name: "TNS",
                    link: "https://wis-tns.weizmann.ac.il/search?ra=" +
                          this.ra +
                          "&decl=" +
                          this.dec +
                ...
                {
                    name: "PanSTARRS",
                    link: "http://ps1images.stsci.edu/cgi-bin/ps1cutouts?pos=" +
                          this.ra +
                          (this.dec > 0
                              ? "+" + this.dec
                              : this.dec) +
                ...
                {
                    name: "SDSS DR15",
                    link: "http://skyserver.sdss.org/dr15/en/tools/chart/navi.aspx?ra=" +
                          this.ra +
                          "&dec=" +
                          this.dec
                }
